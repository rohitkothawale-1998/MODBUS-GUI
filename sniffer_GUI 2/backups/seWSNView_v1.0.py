...
class seWSNToolbar(wx.Frame):
    def __init__(self, parent):
        ...
        parent.Bind(wx.EVT_MENU, parent.OnSendPKGNotify, tool9)
...
class PageNetworkMonitor(wx.Panel):
    def __init__(self, parent):
        ...
        parentmacsizer = wx.BoxSizer(wx.HORIZONTAL)
        parentmaclabel = wx.StaticText(nmstat_pane, wx.ID_ANY, "Parent MAC")
        parentmacsizer.Add(parentmaclabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 4)
        self.parentmactxc = wx.TextCtrl(nmstat_pane, wx.ID_ANY, style=tc_stat_style)
        parentmacsizer.Add(self.parentmactxc, 1, 0, 0)
        ...
        hopcountsizer = wx.BoxSizer(wx.HORIZONTAL)
        hopcountlabel = wx.StaticText(nmstat_pane, wx.ID_ANY, "Hop Count")
        hopcountsizer.Add(hopcountlabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 4)
        self.hopcounttxc = wx.TextCtrl(nmstat_pane, wx.ID_ANY, style=tc_stat_style)
        hopcountsizer.Add(self.hopcounttxc, 1, 0, 0)
        blversionsizer = wx.BoxSizer(wx.HORIZONTAL)
        blversionlabel = wx.StaticText(nmstat_pane, wx.ID_ANY, "BL Version")
        blversionsizer.Add(blversionlabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 4)
        self.blversiontxc = wx.TextCtrl(nmstat_pane, wx.ID_ANY, style=tc_stat_style)
        blversionsizer.Add(self.blversiontxc, 1, 0, 0)
        ...
        statnetworksizer.Add(parentmacsizer, 0, wx.RIGHT|wx.EXPAND, 0)
        ...
        statnetworksizer.Add(hopcountsizer, 0, wx.RIGHT|wx.EXPAND, 0)
        statnetworksizer.Add(blversionsizer, 0, wx.RIGHT|wx.EXPAND, 0)
        ...
        self.port1labeltxc = wx.TextCtrl(nmstat_pane, wx.ID_ANY, size=(45,-1), style=tc_stat_style)
        ...
        port1sizer.Add(self.port1labeltxc, 0, 0, 0)
        ...
        self.port2labeltxc = wx.TextCtrl(nmstat_pane, wx.ID_ANY, size=(45,-1), style=tc_stat_style)
        ...
        port2sizer.Add(self.port2labeltxc, 0, 0, 0)
        ...
        self.port3labeltxc = wx.TextCtrl(nmstat_pane, wx.ID_ANY, size=(45,-1), style=tc_stat_style)
        ...
        port3sizer.Add(self.port3labeltxc, 0, 0, 0)
...
class PageTopologyMap(wx.Panel):
    def __init__(self, parent):
        ...
        self.txc = wx.StaticText(self, -1, "This is a Topology object", (20,20))
        topobuttonsizer = wx.BoxSizer(wx.VERTICAL)
        #self.topobutton = wx.Button(self, wx.ID_ANY, "Start Topology Viewer")
        img = wx.Image("rtc0604tc_fs5.gif", wx.BITMAP_TYPE_ANY)
        w = img.GetWidth()
        h = img.GetHeight()
        img2 = img.Scale(w*2, h*2)
        self.sb1 = wx.StaticBitmap(self, -1, wx.BitmapFromImage(img2))
        topobuttonsizer.Add(self.txc, 0, 0, 0)
        #topobuttonsizer.Add(self.topobutton, 0, 0, 0)
        topobuttonsizer.Add(self.sb1, 0, 0, 0)
        self.SetSizer(topobuttonsizer)

        #sizer = wx.BoxSizer(wx.VERTICAL)
        #self.browser = wx.html2.WebView.New(self)
        #sizer.Add(self.browser, 1, wx.EXPAND, 10)
        #self.browser.LoadURL("localhost")
        #self.SetSizer(sizer)
...
class seWSNViewLayout(wx.Frame):
   ...
   def OnSendPKGNotify(self, event):
      ...
      self.UpdatePageTerminal(f"\n ====> Send PKG Notify, Type = {pktype}\n")
      self.UpdatePageTerminal("\n")   
      self.UpdatePageTerminal(StatusReq.hex())
      self.UpdatePageTerminal("\n")
